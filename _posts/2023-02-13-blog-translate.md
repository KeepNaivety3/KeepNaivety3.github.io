...
{% twitter https://twitter.com/_sa_220 maxwidth=500 limit=3 %}

更多内容请参考：[jekyll-twitter-plugin](https://github.com/rob-murray/jekyll-twitter-plugin)

## 6. Github Metadeta

详情见 [github-metadata](http://jekyll.github.io/github-metadata/)
...
在标头添加重定向地址：`redirect: https://www.youtube.com/watch?v=dQw4w9WgXcQ`

## 9. Giscus 评论

在标头添加是否开启评论：`giscus_comments: true`
